...
$langdate['selectTakeOrder'][4]['english']='You can choose one of the following ways to place your 3D model printing order.';
$langdate['selectTakeOrder'][4]['french']='You can choose one of the following ways to place your 3D model printing order.';
...
{
	echo "<script type='text/javascript'>location.href='orderNow.php';</script>";
	exit();
}
?>
...
<div class="w980 auto clearbox mt5">
		...
		<div class="fl mt10 left_box">
			...
			<div class="left_box_c">
				<div class="left_nav">
					<ul>
						<li><a href="/clients/selectTakeOrderType.php" title="" ><?php Lang::EchoString2($langdate['selectTakeOrder'][2]);?></a></li>
						<li><a href="/ElectronicElement/orderNow.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][9]);?></a></li>
						<li><a href="/3DPrinting/selectTakeOrderType.php" title="" class="on"><?php Lang::EchoString2($langdate['selectTakeOrder'][11]);?></a></li>
					</ul>
				</div>
			<div class="mt10">
				...
				<div class="w710 fr mt10">
					...
					<div class="main_box clearbox mt10">
						...
						<div class="right_box1 fr lh2em mr10">
							...
							<p class="txet_p"><a href="orderNow.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][5]);?></a></p>
