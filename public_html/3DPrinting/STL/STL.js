Thingiview = function(setting) {
  scope = this;
  
  this.containerId  = setting.id;
...
function displaySTL(setting){
	thingiview = new Thingiview({
		id:setting.dom,
		width:setting.width,
		height:setting.height
	});
	thingiview.setObjectColor('#88aaee');
	thingiview.initScene();
	thingiview.loadSTL(setting.file);
}