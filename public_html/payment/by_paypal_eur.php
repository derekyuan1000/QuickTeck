...
$langdate['by_paypal_eur'][3]['english']='We use PayPal as a safe, reliable and free way of online payment. Simply click the following "Buy now" link, provide an amount and click Update Totals, then you will be able to make your payment.';
$langdate['by_paypal_eur'][3]['french']='Nous utilisons PayPal comme un moyen sûr, fiable et gratuit de régler une commande. Cliquez simplement sur le lien suivant "Buy now", entrez le montant puis cliquez sur Update Totals. Vous pourrez ensuite effectuer votre paiement.';
...
$langdate['by_paypal_eur'][7]['english']='Please note we never see your credit/debit card details.';
$langdate['by_paypal_eur'][7]['french']='Les détails de votre carte bancaire ou de crédit ne nous seront jamais communiqués';
...
<div class="w980 auto clearbox mt5">
		<div class="w980"><a href="/onlinequote/onlinequote.php" title=""><img src="/rescources/images/banner02.jpg" width="980" height="170" alt="" /></a></div>
