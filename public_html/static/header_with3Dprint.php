...
$langdate['header'][27]['english']='3D printing';
$langdate['header'][27]['french']='3D printing';
$langdate['header'][27]['dutch']='';
$langdate['header'][27]['spanish']='';
?>
<div id="head">
	...
	<ul >
		...
		<li><a href="#" title="" class="nav03 nav_a"><?php Lang::EchoString2($langdate['header'][6]);?></a><i></i>
			<div class="navlist">
				...
				<p><a href="/3DPrinting/onlineQuote.php" title=""><?php Lang::EchoString2($langdate['header'][27]);?></a></p>
			</div>
		</li>
		...
		<div class="navlist">
			<p><a href="<?php echo empty($_SESSION['currentClient'])?"/clients/selectTakeOrderType.php":"/order/takeorder.php?isLogin=yes";?>" title=""><?php Lang::EchoString2($langdate['header'][25]);?></a></p>
				<p><a href="/3DPrinting/selectTakeOrderType.php" title=""><?php Lang::EchoString2($langdate['header'][27]);?></a></p>
