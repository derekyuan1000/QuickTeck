...
session_start();
$_SESSION[message]="";
$langdate['find_pw'][0]['english']='Home';
$langdate['find_pw'][0]['french']='Accueil';
$langdate['find_pw'][0]['dutch']='';
$langdate['find_pw'][0]['spanish']='';
$langdate['find_pw'][1]['english']='A password reset message has been sent to your registered email address. Please sign in and follow the instruction to reset your password';
$langdate['find_pw'][1]['french']='A password reset message has been sent to your registered email address. Please sign in and follow the instruction to reset your password';
$langdate['find_pw'][1]['dutch']='';
$langdate['find_pw'][1]['spanish']='';
?>
...
<div class="w980 auto clearbox mt5">
		...
		<div class="bnav ico_home mt10"><a href="/" title=""><?php Lang::EchoString2($langdate['find_pw'][0]);?></a></div>
		...
		<div class="left_box_b"></div>
				...
				<div class="w710 fr mt10">
							...
							<div class="right_box1 fr lh1.6em mt15">
								<span class="c_f30 ">&nbsp;&nbsp;&nbsp;&nbsp;<?php Lang::EchoString2($langdate['find_pw'][1]);?>.
</span>
								</p>
							</div>
							<div class="clear"></div>
