        ...
        <tr> 
          <td class="style31">
                <div>
                    ...
                    <form name="form1" method="post" action="doSearchOrder.php">
					<table width="450px" border="0" cellpadding="0" cellspacing="1" style="background-color:#C0C0C0; font-size:12px; text-align:left">
                        <tr style="background-color:#D7D59D">
                            <td style="width:130px; height:30px;">
                                <b>&nbsp;Order Number:</b>
                            </td>
                            <td style="width:320px">
                                &nbsp;&nbsp;<input id="number" name="number" type="text" value="<?php echo $_SESSION[errorSearchOrder][0] ?>"/>
                            </td>
                        </tr>
                        <tr style="background-color:#D7D59D">
                            ...
                            <td>
                                &nbsp;&nbsp;<input id="random" name="random" type="text" value="<?php echo $_SESSION[errorSearchOrder][1] ?>"/>
                            </td>
                        </tr>
                        <tr style="background-color:#D7D59D">
                            <td colspan="2" style="text-align:center">
								<input name="Submit" type="submit" class="button" value="submit" onclick="return checkSearchOrder()"/>
							</td>
                        </tr>
                    </table>
					</form>
				...
				<div id="js_Error" style="font-size:14px; font-weight:bold;">
					<?php unset($_SESSION[errorSearchOrder]); echo $_SESSION[message]; $_SESSION[message]=""; ?>
				</div>
            </td>
        </tr>
      </table>
