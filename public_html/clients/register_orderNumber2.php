...
if($_SESSION[searchOrder]){
	$client = $clientService->GetClientById($_SESSION[searchOrder]);
}else{
	return;	
}
?>
...
<script type="text/javascript">
	...
	jq(document).ready(function() {
		jq("#getCheckPic").click(function() {
			jq("#checkPic").attr("src",jq("#checkPic").attr("src")+"?"+Math.random());
		})
	});
</script>
      ...
      <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 524px;">
        ...
        <tr> 
          <td class="style31">
            ...
            <div>
				<div style="font-size: medium; color: #FF6600; font-weight:bold">Register</div>
                Do you have a previous order number?<br />
                <input id="radioOrder" name="rdo1" type="radio" value="0" checked="checked"/>Yes, I have.<br />
                <input id="radioClient" name="rdo1" type="radio" value="1" onclick="javascript:location.href='register_newClient.php'"/>No, I am a new customer.
                <form name="form1" method="post" action="doModifyClient_client.php">
				...
				<table width="530px" border="0" cellpadding="0" cellspacing="1" style="background-color:#C0C0C0; font-size:12px; text-align:left">
                    <tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            ...
                            <input type="button" id="checkLoginId" name="checkLoginId" value="check" onclick="ajaxCheck2('clientLoginId2','loginId','id')"/>
						</td>
                    </tr>
                    <tr style="background-color:#D7D59D">
					...
					<tr style="background-color:#D7D59D">
                        ...
                        <td>
                            &nbsp;&nbsp;<input id="firstName2" name="firstName2" style="width:80px" type="text" value="<?php echo $client->FirstName ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                        <td>
                            <b>&nbsp;Surname:</b>
                        ...
                        <td>
                            &nbsp;&nbsp;<input id="surname2" name="surname2" style="width:80px" type="text" value="<?php echo $client->SurName ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="company2" name="company2" type="text" value="<?php echo $client->Company ?>"/>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="email2" name="email2" type="text" value="<?php echo $client->Email ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="telephone2" name="telephone2" type="text" value="<?php echo $client->Telephone ?>"/>
                        </td>
                    </tr>
                    <tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="addressLineOne2" name="addressLineOne2" style="width: 280px" type="text" value="<?php echo $client->AddressLineOne ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="addressLineTwo2" name="addressLineTwo2" style="width: 280px" type="text" value="<?php echo $client->AddressLineTwo ?>"/>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="cityTown2" name="cityTown2" type="text" value="<?php echo $client->CityTown ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="postcode2" name="postcode2" type="text" value="<?php echo $client->PostCode ?>"/>
							<span style="color:red; font-size:20px; vertical-align:middle">*</span>
                        </td>
                    </tr>
                    <tr style="background-color:#D7D59D">
                    ...
                    <tr style="background-color:#D7D59D">
                        <td style="height:60px;"><b>&nbsp;Verification code:</b></td>
                        <td colspan="3">
                            &nbsp;&nbsp;<input id="checkString" name="checkString" type="text" class="myInput"/><br/>
							&nbsp;&nbsp;<img id="checkPic" src="createCheckPic_client.php" alt="" style="margin-top:5px;vertical-align:bottom"/>
							&nbsp;&nbsp;<a id="getCheckPic" href="#checkString" style="color:#005AA0">Try a different image.</a>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                    ...
                    <tr style="background-color:#D7D59D">
                        <td colspan="4" style="text-align:center">
                            <input id="image2" type="image" value="submit" src="/Management/Images/b_save.gif" onclick="return checkAddClient()"/>
                        </td>
                    </tr>
                </table>
				</form>
