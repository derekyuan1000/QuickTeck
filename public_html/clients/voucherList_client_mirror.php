  ...
  <tr>
    ...
    <td valign="top" style="width: 563px">
      <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 524px;">
        ...
        <tr valign="top">
          <td class="style31">
			<div style="font-size: medium; color: #FF6600; font-weight:bold">Voucher List:
			<input style="float:right;" type="button" value="Request Voucher" onclick="window.location.href='voucherList_clientup.php'" /></div>
			...
			<table width="550px" border="0" cellpadding="0" cellspacing="1" style="background-color:#a8c7ce; font-size:12px; text-align:center">
				<tr style="background-color:#D7D59D; color:#344b50; font-weight:bold">
					<td style="width:33%; height:20px;">Voucher Number</td>
					<td style="width:33%">Discount</td>
					<td style="width:33%">Expired Time</td>
				</tr>
				<?php
				...
				?>
					<tr style="background-color:#D7D59D; color:#344b50">
						<td style="height:20px;">
							<?php echo $voucherArray[$i]->Number?>
						</td>
						<td>
							<?php echo ceil($voucherArray[$i]->Percent)."%(Up to &pound;".$voucherArray[$i]->MaxPrice.")"?>
						</td>
						<td>
							<?php echo Common::ChangeDateFormat($voucherArray[$i]->ExpiredTime,"date");?>
						</td>
					</tr>
				<?php
					}
