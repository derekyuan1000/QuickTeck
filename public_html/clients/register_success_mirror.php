    ...
    <td valign="top" style="width: 563px"> 
      <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 524px;">
        ...
        <tr> 
          <td class="style31">
			<div>
				<div style="font-size: medium; color: #FF6600; font-weight:bold">Register Success</div>
				<table width="530px" border="0" cellpadding="0" cellspacing="1" style="background-color:#C0C0C0; font-size:12px; text-align:left">
					<tr style="background-color:#D7D59D">
						...
						<td colspan="3">
							&nbsp;&nbsp;<?php echo $client->LoginId ?>
						</td>
					</tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px; color:red; font-size:14px" colspan="4">
                    ...
                    <tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php echo $client->AddressLineOne ?>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php echo $client->AddressLineTwo ?>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                    ...
                    <tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php $country = Common::GetCountryById($client->CountryId); echo $country ?>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px; color:red; font-size:14px" colspan="4">
					...
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php echo $receiver->AddressLineOne ?>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php echo $receiver->AddressLineTwo ?>
                        </td>
                    </tr>
					<tr style="background-color:#D7D59D">
                        <td style="height:30px;">
					...
					<tr style="background-color:#D7D59D">
                        ...
                        <td colspan="3">
                            &nbsp;&nbsp;<?php $country2 = Common::GetCountryById($receiver->CountryId); echo $country2 ?>
                        </td>
                    </tr>
				</table>
			</div>
