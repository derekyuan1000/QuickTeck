			...
			<div class="main_box clearbox mt10">
				...
				<div class="right_box1 fr lh2em mr10" style="padding-bottom:30px;">
	                ...
	                <div class="tab-container">
	                	<div id="from_uk">
		                	<p class="txet_p"><a href="clientLogin.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][5]);?> [From UK]</a></p>
							<p class="txet_p"><a href="register_newClient.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][6]);?> [From UK]</a></p>
		                ...
		                <div id="from_china">
		                	<p class="txet_p"><a href="clientLogin.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][5]);?> [From China]</a></p>
							<p class="txet_p"><a href="register_newClient.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][6]);?> [From China]</a></p>
