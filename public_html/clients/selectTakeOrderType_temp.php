		...
		<div class="w710 fr mt10">
			...
			<div class="main_box clearbox mt10">
				...
				<div class="right_box1 fr lh2em mr10">
					<p style="font-size:18px;margin-bottom:30px;"><?php Lang::EchoString2($langdate['selectTakeOrder'][4]);?></p>

		            <p class="txet_p"><a href="/clients/clientLogin.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][5]);?></a></p>
					<p class="txet_p"><a href="/order/takeorder.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][6]);?></a>[<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/not_register_comment.php');">?</span>]</p>
					<p class="txet_p"><a href="/sinoOrder/takeorder.php" title=""><?php Lang::EchoString2($langdate['selectTakeOrder'][7]);?></a> [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/not_register_comment.php');">?</span>]</p>
				</div>
				<div class="clear"></div>
			</div>
		</div>
