  ...
  <tr> 
    ...
    <td valign="top" style="width: 563px"> 
      <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 524px;">
        ...
        <tr> 
          <td class="style31" style="padding-left:20px">

            <div id="divAdminLogin">
                <form name="form1" method="post" action="doFindPassword_client.php">
					<br>
                    <table width="450px" border="0" cellpadding="7" cellspacing="0">
                        <tr>
                            <td colspan="2" style="color:blue; font-size:12px;">Forgot your password? Please enter your user ID and email address you registered with us.</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align:center; color:blue; font-size:14px; font-weight:bold">Reset Password Form</td>
                        </tr>
						<tr>
                            <td style="width:170px; text-align:right; font-weight:bold; color:#0000FF; font-size:14px;">User ID:</td>
                            <td style="width:280px; text-align:left">
                                <input id="loginId" name="loginId" type="text" class="myInput" value="<?php echo $_SESSION[clientFindPW]->LoginId ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:right; font-weight:bold; color:#0000FF; font-size:14px;">Email:</td>
                            <td style="text-align:left">
                                <input id="email" name="email" type="text" class="myInput" value="<?php echo $_SESSION[clientFindPW]->Email ?>"/>
                            </td>
                        </tr>
                        <tr>
							<td style="text-align:right; font-weight:bold; color:#0000FF; font-size:14px;">Verification code:</td>
							<td style="text-align:left">
								...
								&nbsp;&nbsp;<a id="getCheckPic" href="#" style="color:#005AA0">Try a different image.</a>
							</td>
						</tr>
                        <tr>
                            <td colspan="2" style="text-align:center">
                                <input name="Submit" type="submit" class="button" value="Submit" onclick="return checkFindPassword()"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align:center;">
                                <div id="js_Error" style="font-size:14px; font-weight:bold;">
				                    <?php unset($_SESSION[clientFindPW]); echo $_SESSION[message]; $_SESSION[message]=""; ?>
			                    </div>
                            </td>
                        </tr>
                    </table>
