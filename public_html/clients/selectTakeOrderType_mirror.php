...
function move(){
	$("mscroll").style.pixelTop = document.documentElement.scrollTop + 5;
}
...
<tr><td  bgcolor="99cc33" class="style2" width="100%" height="40">
<strong>Order Portal</strong>
</td></tr>
        
        
        <tr> 
          <td class="style31" style="font-size:14px">
				<br>
				<?php
				if(empty($_SESSION[currentClient])){
				?>
<br>
You can choose one of the following ways to place your order.<br><br>
				<a style="color:blue; font-size:14px;text-decoration:underline"; href="../order/takeorder.php?isLogin=yes">Login and place an order</a><br><br>
				<a style="color:blue; font-size:14px;text-decoration:underline"; href="register_newClient.php">Register and place an order</a><br><br>
                <a style="color:blue; font-size:14px;text-decoration:underline"; href="../order/takeorder.php">Place an order without registering</a>  
                [<span class="style6"><strong onclick="myOpen('/comment/not_register_comment.php',250,400)">?</strong></span>]<br>
