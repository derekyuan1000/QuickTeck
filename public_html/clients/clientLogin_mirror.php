      ...
      <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 524px;">
        ...
        <tr> 
          <td class="style31" style="padding-left:20px">
            ...
            <div id="divAdminLogin">
                <form name="form1" method="post" action="doLogin_client.php">
                    ...
                    <table width="450px" border="0" cellpadding="7" cellspacing="0">
                        <!--<tr>
                            <td colspan="2" style="text-align:center; font-weight:bold; color:#0000FF; font-size:14px;">Client Login</td>
                        </tr>-->
                        <tr>
                            <td style="width:140px; text-align:right; font-weight:bold; color:#0000FF; font-size:14px;">User ID:</td>
                            <td style="text-align:left">
                                <input id="loginId" name="loginId" type="text" class="myInput" value="<?php echo $_SESSION[clientLogin]?>"/>
								<!--&nbsp;&nbsp;<a href="findLoginId_client.php" style="color:#005AA0">Forgot your ID</a>-->
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:right; font-weight:bold; color:#0000FF; font-size:14px;">Password:</td>
                            <td style="text-align:left">
                                <input id="password" name="password" type="password" class="myInput"/>
								&nbsp;&nbsp;<a href="findPassword_client.php" style="color:#005AA0">Forgot your password</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align:center">
                                <input name="Submit" type="submit" class="button" value="Login" onclick="return checkClientLogin()"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;
			...
			<br/>
			<div style="text-align:center;font-weight:bold; color:blue; font-size:12px;">
				<a href="register_newClient.php" style="color:blue; text-decoration:underline">New customer, Register here</a>
			</div>
          </td>
        </tr>
      </table>
