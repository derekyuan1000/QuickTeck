...
$langdate['ordercompleted'][2]['english']='Sorry, your payment for '.$number.' did not gone through.';
$langdate['ordercompleted'][2]['french']='Sorry, your payment for '.$number.' did not gone through.';
$langdate['ordercompleted'][2]['dutch']='';
$langdate['ordercompleted'][2]['spanish']='';
$langdate['ordercompleted'][3]['english']='Can you please contact us with your order number so we can check it for you. Alternatively, you can try to use PayPal or BACS to complete your payment. Thanks.';
$langdate['ordercompleted'][3]['french']='Can you please contact us with your order number so we can check it for you. Alternatively, you can try to use PayPal or BACS to complete your payment. Thanks.';
...
<head>
<title>PCB from low cost PCB Manufacturer UK,PCB price,UK PCB factory, UK PCB Manufacturer,Prototype PCB manufacturer</title>
