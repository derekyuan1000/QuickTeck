...
unset($_SESSION[searchTypeId]);
unset($_SESSION[searchKeyWord]);

$pcbKey_shoppingCarId = $_GET[pcbKey];
$pcbOrderId = $_GET[pcbOrderId];
$pcbOrderCheckout = $_GET[pcbOrderCheckOut];

if($pcbKey_shoppingCarId){
	$_SESSION[shoppingCartId] = $pcbKey_shoppingCarId;//use to checkout pcb
	$_SESSION[PCBOrderId] = $pcbOrderId;//use to check whether order pcb
	$_SESSION[PCBOrderNotCheckout] = "YES";//no need checkout pcb
}
if($pcbOrderCheckout){
	$_SESSION[shoppingCartId] = $pcbKey_shoppingCarId;
	$_SESSION[PCBOrderId] = $pcbOrderId;
	$_SESSION[PCBOrderNotCheckout] = "NO";//need checkout pcb
}
...
$_SESSION[shoppingCarTypeId] = $typeId;
...
$eeType = $eeTypeService->GetEETypeById($typeId);
$strTypeIds = $eeTypeService->GetParentAndChildrenEETypeById($typeId);
if(!$strTypeIds){
	$strTypeIds = $eeTypeService->GetParentAndChildrenEETypeById(1);
}
$result = $eeElectronicElementService->GetEEElectronicElementsByTypeIdsAndPage($strTypeIds, Config::$pageSize, $currentPage, $oaId, "6,78", $searchKeyWord, $orderMode);

$recoudCount = $result[0];
$eeArray = $result[1];
$pager = new Pager(Config::$pageSize,$recoudCount,$currentPage,"eeList.php?typeId=".$typeId."&oaId=".$oaId."&omId=".$omId."&doId=".$doId."&page=");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>PCB Manufacturing,UK printed circuit board Online Quote,UK PCB Manufacturer,circuit board,manufacture,electronics components online</title>
<meta name="description" content="Low Cost PCB Manufacturing,Online Quote PCB,pcb manufacture,UK circuit board Prototype Fabrication,electronics componnents order online,PCB assembly,printed circuit board." />
<meta name="keywords" content="Low Cost PCB Manufacturing,Online Quote PCB price,pcb manufacturer,UK PCB Prototype Manufacture,pcbs,PCB Prototype Fabrication,Fabrication,electronics componenets order online" />
...
<div class="w980 auto clearbox mt5">
		...
		<div name="title" id="title" class="bnav ico_home mt10"><a href="/" title="">Home</a> - <a href="#" title="">Electronic component</a></div>
            ...
            <div class="Titlediv" style="margin-top:10px">
                <table cellspacing="5" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td class="td2">
                            <a href="<?php echo "eeList.php?typeId=".$typeId."&oaId=4&omId=1&doId=2"; ?>"><img <?php if($doId == 2){echo "src='../rescources/images/eeList_03.gif'";}else{echo "src='../rescources/images/eeList_01.gif'";} ?> height="36"/></a>
                        </td>
                        <td class="td3">
							<a href="<?php echo "eeList.php?typeId=".$typeId."&oaId=4&omId=2&doId=3"; ?>"><img <?php if($doId == 2){echo "src='../rescources/images/eeList_04.gif'";}else{echo "src='../rescources/images/eeList_02.gif'";} ?> height ="36"/></a>
                        </td>
                        <td class="td4">
						...
						<tr>
							...
							<td class="w_180">
								<?php 
									//Name
									$attributeValue = $attributeValueArray[78];
									echo "<a href='eeDetail.php?eeId=".$eeArray[$i]->Id."' style='font-weight:bold; color:blue; font-size:14px'>".$attributeValue->AttributeValue."</a>";
								?>
							</td>
							<td class="w_150">
								<?php 
						...
						<tr>
							...
							<td>
								<?php 
									...
									echo $eeAttributeArray[6]->Name.":&nbsp".$attributeValue->AttributeValue;
								?>
							</td>
							<td>
								<?php 
						...
						<tr>
							<td>
								<?php 
									...
									echo "Order code:&nbsp".$attributeValue->AttributeValue;
								?>
							</td>
							<td>
								&nbsp;
						...
						<tr>
							<td>
								<?php 
									...
									echo "Part no:&nbsp".$attributeValue->AttributeValue;
								?>
							</td>
							<td>
								<?php 
