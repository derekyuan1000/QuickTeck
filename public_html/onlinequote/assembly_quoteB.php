...
$langdate['assembly'][36]['english']='Although our China based assembly factory will keep providing the service as normal, in the UK we provide a fast turnaround, low volume PCB circuit assembly service where we assemble your order and despatch in up to 3 days after receipt of PCB\'s and components. More details can be found <a class="c_f30" target="_blank" href="https://www.quick-teck.co.uk/News/Content.php?Id=111">here</a>.'; 
$langdate['assembly'][36]['french']='Although our China based assembly factory will keep providing the service as normal, in the UK we provide a fast turnaround, low volume PCB circuit assembly service where we assemble your order and despatch in up to 3 days after receipt of PCB\'s and components. More details can be found <a class="c_f30" target="_blank" href="https://www.quick-teck.co.uk/News/Content.php?Id=111">here</a>.';
...
<head>
<title>PCB Assembly in UK,Assembly quote online,Online Quote PCB manufacture,UK Printed circuit board Manufacturer,Prototype manufacturer assembly</title>
				...
				<div class="w710 fr mt10">
				 <form name="calc" id="calc" >
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
					  ...
					  <tr>
						<td class="w_168">8. <?php Lang::EchoString2($langdate['assembly'][12]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/assemblyinUK_comment.php');">?</span>]</td>
						<td>
