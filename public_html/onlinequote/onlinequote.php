...
$langdate['onlinequote'][68]['english']='Need Assembly and components together with PCBs';
$langdate['onlinequote'][68]['french']='Need Assembly and components together with PCBs';
$langdate['onlinequote'][68]['dutch']='';
$langdate['onlinequote'][68]['spanish']='';
$langdate['onlinequote'][69]['english']='Assembly: get on online quote <a class="c_f30" target="_blank" href="/onlinequote/assembly_quoteB.php">here</a>.<br>
...
$langdate['onlinequote'][69]['french']='Assembly: get on online quote <a class="c_f30" target="_blank" href="/onlinequote/assembly_quoteB.php">here</a>.<br>
Components: check our inventory of over 4000 components or send us a bill of materials (BOM) and we will calculate the cost for you. To find out more about the process and what information we will need from you, check our <a href="/FAQ/FAQ.php#PCB_Assembly_001" class="lh2em c_f60">FAQ</a>';
...
$langdate['onlinequote'][72]['english']='Purple';
$langdate['onlinequote'][72]['french']='Purple';
$langdate['onlinequote'][72]['dutch']='';
$langdate['onlinequote'][72]['spanish']='';
...
<div class="dialogWindowBin2" id="dialogWindowBin2" style="display:none"><!-- use inline or none to switch on/off windows --> 
	<a href="/News/Content.php?Id=118">
    <img src="/images/info.png" align="middle">
      <p></p>
    <span style="color:#F30;"><br />2023 Chinese New Year Holiday Period Arrangement</span></a></br>
				...
				<form name="calc" id="calc" action="" method="post">
					...
					<tr>
						...
						<td>
							...
							<input name="soldermaskcolor" type="radio" value="10" onclick="calculate_total('onlineQuote')"><span style="font-size:25px;color:purple">■</span><?php Lang::EchoString2($langdate['onlinequote'][72]);?></li>
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<td>
				<input name="surface" type="radio" checked="checked" value="2" onclick="calculate_total('onlineQuote')"><?php Lang::EchoString2($langdate['onlinequote'][36]);?> &nbsp;&nbsp;
							<input name="surface" type="radio" value="3" onclick="calculate_total('onlineQuote')"><?php Lang::EchoString2($langdate['onlinequote'][37]);?>&nbsp;&nbsp;					<input name="surface" type="radio" value="4" onclick="calculate_total('onlineQuote')">OSP&nbsp;&nbsp;
