...
.title_main_small{
    background: url(/rescources/images/title_main_small.gif) no-repeat;
}
.online_from table {width: 690px;}
.bg,form{
    background: none;
}
</style>
...
function orderNow(){
	top.location.href='../clients/selectTakeOrderType_temp.php';
}
</script>
...
<!--<div class="dialogWindowBin2" id="dialogWindowBin2">
	...
	<form name="calc" id="calc" action="" method="post">
		<div class="online_from"><!--online_from-->
			<div id="calPCB">
					   ...
					   <td class="w_168">12. <?php Lang::EchoString2($langdate['onlinequote'][16]);?>:</td>
    					<td>
    						...
    						<select name="country" id="country" style="width: 250px" onchange="calculate_totalB('onlineQuote');">
    							...
    							{
    								if ($allCountries[$i]->Id == 14) {
                                        echo '<option value="'.$allCountries[$i]->Id.'" selected>'.$allCountries[$i]->ENShortName.'</option>';
                                    }else{
			...
			<div id="calResult">
				<h3 class="title_main title_main_small">Price &amp; Build Time
                ...
                <p class="title_main title_main_small" style="margin-top:20px;">Shipping costs</p>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mt10 tab1"  >
                      <tr>
                            <td align="center" width="180"><span style="font-weight:bold;">Carrier</span></td>
                            <td align="center" width="180"><span style="font-weight:bold;">Cost</span><span id="currencyType" name="currencyType"></span></td>
                            <td align="center" width="180"><span style="font-weight:bold;">Estimated shipping time</span></td>
                      </tr>
                      <tr>
                            <td align="center">
                            ...
                            <td align="center"><span class="c_red" id="shippingCost" name="shippingCost" >&nbsp;</span></td>
                            <td align="center">3-7 days</td>
                      </tr>
                    </table>

                    <p class="mt10 tc" style="color:red;font-size:14px;">
                        Total amount<span id="currencyType" name="currencyType"></span>: 
                        <span class="c_red" id="totalAmount" name="totalAmount" style="font-size:18px;font-weight:bold">&nbsp;</span>
                    </p>

                    <p class="mt10 tc">
                        <input type="button" value="Order now" class="submit_bn" onclick="calculate_totalB('onlineQuote');orderNow();">
                    </p>
