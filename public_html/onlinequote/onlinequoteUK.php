		...
		<div class="online_from">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
		        <tr>
        			...
        			<td>
        				<input name="layer" type="radio" value="1" checked="checked" onclick="changeLayer('onlineQuote');calculate_total('onlineQuote')" />1&nbsp;
        				<input name="layer" type="radio" value="2" onclick="changeLayer('onlineQuote');calculate_total('onlineQuote')" />2&nbsp;
		        ...
		        <tr>
        			...
        			<td><input name="quantity" type="text" onblur="calculate_total('onlineQuote')" />&nbsp;(<?php Lang::EchoString2($langdate['onlinequote'][52]);?>)</td>
        		</tr>
		        <tr>
			        ...
			        <td><input type="text" name="length" onblur="calculate_total('onlineQuote')" />&nbsp; (<?php Lang::EchoString2($langdate['onlinequote'][53]);?>)</td>
		        </tr>
		        <tr>
        			<td class="w_168">4. <?php Lang::EchoString2($langdate['onlinequote'][9]);?>:</td>
        			<td><input type="text" name="width" onblur="calculate_total('onlineQuote')" />&nbsp; (<?php Lang::EchoString2($langdate['onlinequote'][54]);?>)</td>
        		</tr>
		        <tr>
        			...
        			<td>
        				<select name="material" id="material" onchange="calculate_total('onlineQuote')">
