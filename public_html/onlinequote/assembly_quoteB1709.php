...
$langdate['assembly'][12]['english']='Lead free';
$langdate['assembly'][12]['french']='Sans plomb';
...
$langdate['assembly'][28]['french']='Délai de livraison';
				...
				<div class="w710 fr mt10">
				 <form name="calc" id="calc" >
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
					  ...
					  <tr>
						<td class="w_168">8. <?php Lang::EchoString2($langdate['assembly'][12]);?>:</td>
						<td>
							<input name="leadFree" id="leadFree" type="radio" value="1" onclick="calculate_assemblyB('onlineQuote')"><?php Lang::EchoString2($langdate['assembly'][23]);?>
							<input name="leadFree" id="leadFree" type="radio" value="0" checked="checked" onclick="calculate_assemblyB('onlineQuote')"><?php Lang::EchoString2($langdate['assembly'][24]);?></td>
					  </tr>
					</table>
					<p class="mt10 tc">
