...
<head>
	...
	function getMailCount(){
		...
		jq.post("../Do/doAjaxGetMailCount.php",{t:t, type:1},function(data){jq("#needAssignMailCount").html(data)});

		jq.post("../Do/doAjaxGetMailCount.php",{t:t, type:2, adminId:adminId },function(data){jq("#needReplyMailCount").html(data)});

		jq.post("../Do/doAjaxGetMailCount.php",{t:t, type:3},function(data){jq("#needApproveMailCount").html(data)});

		jq.post("../Do/doAjaxGetMessageCount.php",{t:t, adminId:adminId},function(data){jq("#unReadAdminMessageInboxCount").html(data)});
