...
$result = $weeklyReportService->GetAllWeeklyReportsByPage(Config::$pageSize, $currentPage, 0, 0, $currentAdmin->Id, "2,3,4");
	...
	<div style="margin:3px;">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" style="background-color:#a8c7ce; text-align:center; font-size:13px">
			...
			<tr style="background-color:#ffffff; color:#344b50;"
				...
				<td>
					<a href="weekReportRead.php?page=<?php echo $currentPage ?>&id=<?php echo $weeklyReportArray[$i]->Id ?>"><img alt="edit" src="../Images/b_browse.png" border="0"/></a>
				</td>
			</tr>
			<?php
			}
