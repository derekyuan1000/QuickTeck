...
{
/**	const PROTOCOL = '2.23'; changed to 3.0 by Harry 21/02/2025*/
	const PROTOCOL = '3.0';
	...
	public function __construct($vendorName, $environment = 'TEST')
	{
		...
		$this->_request_construction['Currency'] = 'GBP';
	...
	{
		$this->_transaction_reference = $this->_vendor_name . "-" . date('d_m_h_i_s') . "GBP-" . rand(0,4200);
