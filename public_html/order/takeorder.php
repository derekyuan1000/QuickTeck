...
<a href="http://www.facebook.com/quickteck"  target="_blank"><img src="/rescources/images/img2.gif" width="30" height="30" alt="" /></a></p>
		...
		<div class="left_box_b"></div>
				...
				<form enctype="multipart/form-data" name="calc" id="calc" action="<?php if($_GET['isACOrder']==1 || $orderDetail->BaseMaterial == 2 || $orderDetail->BaseMaterial == 3){ echo 'takeorderAC2.php';}else{echo 'takeorder2.php';}?>" method="post" style="width: 100%;" class="style1" onsubmit="return checkForm();">
				...
				<?php }?>
					...
					<tr><td colspan="4"><span class="fw c_f30 fs14"><?php Lang::EchoString2($langdate['takeorder'][13]);?></span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#firstName" onclick="copyForm();" style="color:#D30;display:none;" >Copy from billing information</a></td></tr>
					  ...
					  <tr><td colspan="4"><span class="fw c_f30 fs14">PCB material Information</span>
					  <tr>
						<td>PCB material:</td>
						 <td colspan="3">
							<input name="layer" type="radio" value="1" <?php if($_GET['isACOrder']!=1 || $orderDetail->BaseMaterial == 0 || $orderDetail->BaseMaterial == 1){ echo 'checked="chedked"';}?> onclick="document.calc.action='takeorder2.php'"/>FR4 Board &nbsp;
							<input name="layer" type="radio" value="2" <?php if($_GET['isACOrder']==1 || $orderDetail->BaseMaterial == 2 || $orderDetail->BaseMaterial == 3){ echo 'checked="chedked"';}?> onclick="document.calc.action='takeorderAC2.php'"/>Aluminum Board
						</td>
					  </tr>
