...
<!--IndexPage.Content.Begin-->
  <?php include("../Management/Client/row1.php") ?> 
  	...
  	<tr><td colspan="2" style="height: 13px"></td></tr>  
            <tr> 
 <td class="style31">
                <form enctype="multipart/form-data" name="calc" id="calc" action="order-submit0.php" method="POST" style="width: 100%;" class="style1" target="_blank">
...
<table style="width: 100%">
	<tr>
		<td class="style3" style="width: 104px" ><span class="style13">*</span><span class="style16">Your name: </span>
		</td><td class="style3"><input name="name" type="text"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px">Phone number: </td><td class="style3" ><input name="phone" type="text"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px"><span class="style13">*</span><span class="style16">Email: </span>
		</td><td class="style3" ><input name="email" type="text" style="width: 163px"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px"><span class="style13">*</span><span class="style16">Delivery address line 1: </span></td><td class="style3" >
		<input name="deliveryaddress1" type="text" style="width: 288px"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px; height: 42px;"><span class="style13">*</span><span class="style16">Delivery address line 2: </span></td>
		<td  class="style3" style="height: 42px"><input name="deliveryaddress2" type="text" style="width: 288px"></td>
	</tr>
    <tr>
		<td  class="style3" style="height: 28px; width: 104px;"> 
		<span class="style13">*</span> <span class="style16">Delivery postcode: </span></td>
		<td class="style3" ><input name="deliverypostcode" type="text" style="width: 70px"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px">Company: </td>
		<td class="style3" ><input name="company" type="text" style="width: 149px"></td>
	</tr>
	<tr>
		<td  class="style3" style="width: 104px">Country: </td>
		<td class="style3" >
...
<tr>
	...
	<td class="style3">
		<input name="quantity" type="text" style="width: 74px" onblur="calculate_total('takeOrder')"> (1 to 150)
	</td>
</tr>
<tr>
	<td class="style3">
	...
	<td class="style3">
		<input type="text" name="length" onblur="calculate_total('takeOrder')"> (10 to 500mm)
	</td>
</tr>
<tr>
	<td class="style3">
	...
	<td class="style3">
		<input type="text" name="width" onblur="calculate_total('takeOrder')"> (10 to 500mm)
	</td>
</tr>
<tr>
	<td class="style3">
...
<tr>
	<td colspan="2" style="height: 10px">
		...
		<font color=red>*</font> Shipping cost included.
	</td>
...
<tr>
	<td style="height: 10px" class="style3">
		<span class="spanNo"></span>.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="terms" type="checkbox" >
	</td>
	<td class="style3">
...
<input type="submit" value="Take this order" style="width: 135px; height: 35px;" class="style17"><small><span class="style13">&nbsp;*</span> 
