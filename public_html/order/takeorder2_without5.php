...
<span style= "display:none">
                   ...
                   <input name="days" type="radio" style="width: 20px" value="10" onclick="changeDays('takeOrder');calculate_total('takeOrder')">10   
							<input name="days" type="radio" style="width: 20px" value="16" onclick="changeDays('takeOrder');calculate_total('takeOrder')">Laid-back Price[<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/laidback_comment.php');">?</span>] <br />&nbsp;&nbsp;&nbsp;&nbsp;
                            5 working day lead times are temporarily unavailable due to the impact of Coronavirus measures.
						</td>
						</tr>
					   <tr>
