					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
					  ...
					  <tr>
                       ...
                       <tr>
						 ...
						 <td colspan="3">
							<input name="surface" type="radio" value="1" <?php if($orderDetail->Surface == 1){echo 'checked="checked"';} ?> onclick="calculate_total('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][35]);?>
							...
							<input name="surface" type="radio" value="3" <?php if($orderDetail->Surface == 3){echo 'checked="checked"';} ?> onclick="calculate_total('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][37]);?><br>
...
<span style= "display:none">
		...
		<input name="days" type="radio" style="width: 20px" value="9" onclick="changeDays('takeOrder');calculate_total('takeOrder')">10
</span>	     
							<input name="days" type="radio" style="width: 20px" value="16" onclick="changeDays('takeOrder');calculate_total('takeOrder')" checked="checked">Laid-back Price[<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/laidback_comment.php');">?</span>] <br />&nbsp;&nbsp;&nbsp;&nbsp;
                            5 to 9 working day lead times are temporarily unavailable due to the impact of Coronavirus measures. The average laid-back lead time is 12.5 days measured in 30<sup>th</sup> March 2020.
						</td>
						</tr>
					   <tr>
