...
if (isset($_POST['submit']) && !empty($_POST['payment_value']) && is_numeric($_POST['payment_value'])) {
	...
	if ($payment_value < $minimum_value || $payment_value > $maximum_value) {
		...
		$sagepay_server->setReference($_POST['ordernumber']."USD-".$payment_value*100);
...
<a href="https://www.facebook.com/quickteck"  target="_blank"><img src="/rescources/images/img2.gif" width="30" height="30" alt="" /></a></p>
		...
		<div class="left_box_b"></div>
				...
				<form  action="manualpaymentUSD.php" method="post">
				...
				<tr>
					<td class="style3" style="width: 170px"><span class="style13">*</span><?php Lang::EchoString2($langdate['manualpayment'][4]);?>(&dollar;):</td><td class="style3"><input type="number" name="payment_value" step="0.01" value="<?php echo $payment_value ?>" style="width: 100px"/></td>
				</tr>
				<tr>
