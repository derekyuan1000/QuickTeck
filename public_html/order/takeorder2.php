...
$langdate['takeorder2'][60]['english']='Purple';
$langdate['takeorder2'][60]['french']='Purple';
$langdate['takeorder2'][60]['dutch']='';
$langdate['takeorder2'][60]['spanish']='';
					...
					<!--			<input name="weight" type="radio" value="0.5" <?php if($orderDetail->CopperWeight == "0.5"){echo 'checked="checked"';} ?> onclick="calculate_total('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][27]);?> -->
					  ...
					  <tr>
						...
						<td>
							...
							<input name="soldermaskcolor" type="radio" <?php if($orderDetail->Int3 == "10"){echo 'checked="checked"';} ?> value="10"><span style="font-size:25px;color:purple">■</span><?php Lang::EchoString2($langdate['takeorder2'][60]);?>
						</td>
					  </tr>
                       <tr>
