	...
	function createPager2(){
		...
		$pagerStr = 
			...
			<tr style="color:black;">
				...
				<td style="width:45px; line-height:15px; text-align:center;font-size:10px;border:none;">'.$firstPageStr.'</td>
				<td style="width:5px;border:none;"></td>
				<td style="width:45px; text-align:center; font-size:10px;border:none;">'.$prewPageStr.'</td>
				<td style="width:5px;border:none;"></td>
				<td style="width:45px; text-align:center; font-size:10px;border:none;">'.$nextPageStr.'</td>
				<td style="width:5px;border:none;"></td>
				<td style="width:45px; text-align:center; font-size:10px;border:none;">'.$lastPageStr.'</td>
			</tr>
		</table>';
		echo $pagerStr;
	}
