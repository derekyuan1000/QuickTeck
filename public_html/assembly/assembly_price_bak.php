...
<head>
<title>Quick-teck,Low Cost PCB Manufacturer,Online Quote,UK PCB Manufacturer, Prototype manufacturer</title>
...
<div class="w980 auto clearbox mt5">
		...
		<div class="bnav ico_home mt10"><a href="/" title="">Home</a> - <a href="#" title="">Assembly quote</a> </div>
...
$to_ch = "1206200302@qq.com,1691195126@qq.com,info@quick-teck.co.uk";//Chinese Email To
$from_ch = "quickte2@cl84.justhost.com";//Chinese Email From

$name = $_REQUEST['name'] ; 
//$headers = "From: $from"; 
$headers = "From:$from\r\nBCC:$bcc\r\nContent-type:text/html; charset=utf-8";
//$subject = "Web Contact Data(assembly_quote)"; 
$subject = "Assembly Service Quote Form"; 
...
/*$body = "We have received the following information:
		The uploade assembly file is:\" ". basename( $_FILES['uploaded']['name']). " \"
		<br>The order information is the following: <br>";*/

$body = "Assembly Service Quote Form<br><br>The uploade assembly file is:\" ". basename( $_FILES['uploaded']['name']). " \"<br>";
