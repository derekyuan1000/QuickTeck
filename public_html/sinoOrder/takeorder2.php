<?php
session_start();
include_once($_SERVER['DOCUMENT_ROOT']."/Management/Models/SinoOrderDetail_Class.php");
...
if(!empty($_SESSION[pcbOnlineBCuoteData])){
	$orderDetail = unserialize($_SESSION[pcbOnlineBCuoteData]);
}
?>
...
<a href="http://www.facebook.com/quickteck"  target="_blank"><img src="/rescources/images/img2.gif" width="30" height="30" alt="" /></a></p>
		...
		<div class="left_box_b"></div>
				...
				<input type="hidden" name="country_out" value="<?php echo $_POST['country_out']?>"/> 
					...
					<div id="calPCB">
					<h3 class="title_main" style="margin-bottom:10px">PCB Specification Selection</h3>
					<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                       <tr>
						 ...
						 <td colspan="3">
							<input name="layer" type="radio" value="1" <?php if($orderDetail->Layer == 1){echo 'checked="checked"';} ?> onclick="changeLayer('');calculate_totalB('takeOrder')"/>1
							<input name="layer" type="radio" value="2" <?php if($orderDetail->Layer == 2){echo 'checked="checked"';} ?> onclick="changeLayer('');calculate_totalB('takeOrder')"/>2
							<input name="layer" type="radio" value="4" <?php if($orderDetail->Layer == 4){echo 'checked="checked"';} ?> onclick="changeLayer('');calculate_totalB('takeOrder')"/>4
							<input name="layer" type="radio" value="6" <?php if($orderDetail->Layer == 6){echo 'checked="checked"';} ?> onclick="changeLayer('');calculate_totalB('takeOrder')"/>6
							<input name="layer" type="radio" value="8" <?php if($orderDetail->Layer == 8){echo 'checked="checked"';} ?> onclick="changeLayer('');calculate_totalB('takeOrder')"/>8
					   </tr>
                       ...
                       <tr>
						 ...
						 <td colspan="3"><input id="quantity" name="quantity" type="text" value="<?php echo $orderDetail->Quantity; ?>" style="width: 74px;behavior:url(#default#savehistory);" onblur="calculate_totalB('takeOrder')"> (1 <?php Lang::EchoString2($langdate['takeorder2'][48]);?> 300) </td>
					   </tr>
                       <tr>
						 ...
						 <td colspan="3"><input id="length" type="text" name="length" value="<?php echo $orderDetail->Length; ?>" onblur="calculate_totalB('takeOrder')">(10 <?php Lang::EchoString2($langdate['takeorder2'][48]);?> 500mm)</td>
					   </tr>
                       <tr>
					  	 <td>4.<?php Lang::EchoString2($langdate['takeorder2'][5]);?>:</td>
						 <td colspan="3"><input id="width" type="text" name="width" value="<?php echo $orderDetail->Width; ?>" onblur="calculate_totalB('takeOrder')"> (10 <?php Lang::EchoString2($langdate['takeorder2'][48]);?> 500mm)</td>
					   </tr>
                       <tr>
						 ...
						 <td colspan="3"><select name="material" id="material" onchange="calculate_totalB('takeOrder')">
                       ...
                       <tr>
						 ...
						 <td colspan="3">
							<input name="thickness" type="radio" value="0.4" <?php if($orderDetail->Thickness == "0.4"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">0.4mm
							<input name="thickness" type="radio" value="0.6" <?php if($orderDetail->Thickness == "0.6"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">0.6mm
							<input name="thickness" type="radio" value="0.8" <?php if($orderDetail->Thickness == "0.8"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">0.8mm
							<input name="thickness" type="radio" value="1.0" <?php if($orderDetail->Thickness == "1.0"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">1.0mm
							<input name="thickness" type="radio" value="1.6" <?php if($orderDetail->Thickness == "1.6"){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="changeThickness('');calculate_totalB('takeOrder')">1.6mm<br>
							<input name="thickness" type="radio" value="2.0" <?php if($orderDetail->Thickness == "2.0"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">2.0mm
							<input name="thickness" type="radio" value="2.4" <?php if($orderDetail->Thickness == "2.4"){echo 'checked="checked"';} ?> onclick="changeThickness('');calculate_totalB('takeOrder')">2.4mm
						</td>
					   </tr>
                       <tr>
						 ...
						 <td colspan="3">
							<input name="weight" type="radio" value="0.5" <?php if($orderDetail->CopperWeight == "0.5"){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][27]);?>
							<input name="weight" type="radio" value="1.0" <?php if($orderDetail->CopperWeight == "1.0"){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][28]);?>
							<input name="weight" type="radio" value="2.0" <?php if($orderDetail->CopperWeight == "2.0"){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][29]);?>
						</td>
					   </tr>
                       <tr>
                       ...
                       <tr>
					  	 <td>9.<?php Lang::EchoString2($langdate['takeorder2'][10]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/silkscreen_comment.php');">?</span>] </td>
						 <td colspan="3">
                       ...
                       <tr>
					  	 <td>10.<?php Lang::EchoString2($langdate['takeorder2'][11]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/surface_comment.php');">?</span>] </td>
						 <td colspan="3">
							<input name="surface" type="radio" value="1" <?php if($orderDetail->Surface == 1){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][35]);?>
							<input name="surface" type="radio" value="2" <?php if($orderDetail->Surface == 2){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][36]);?> 
							<input name="surface" type="radio" value="3" <?php if($orderDetail->Surface == 3){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][37]);?><br>
							<input name="surface" type="radio" value="4" <?php if($orderDetail->Surface == 4){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')">OSP
							<input name="surface" type="radio" value="5" <?php if($orderDetail->Surface == 5){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][38]);?>
						</td>
					   </tr>
					  <tr>
						<td>11.<?php Lang::EchoString2($langdate['takeorder2'][47]);?>:[<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/ULmarking.php');">?</span>]</td>
						<td>
							<input name="ULmarking" id="ULmarking" type="radio" value="1" <?php if($orderDetail->Bool1){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][43]);?>
							<input name="ULmarking" id="ULmarking" type="radio" value="0" <?php if(!$orderDetail->Bool1){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][42]);?>
						</td>
					  </tr>
                       <tr>
					  	 <td>12.<?php Lang::EchoString2($langdate['takeorder2'][13]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/samedesign_comment.php');">?</span>] </td>
						 <td colspan="3">
							<input name="sameDesign" id="sameDesign" type="radio" value="1" <?php if($orderDetail->IsRepeatOrder){echo 'checked="checked"';} ?> onclick="changeDays('takeOrder');showHistoryOrderNumber();calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][43]);?>						
							<input name="sameDesign" id="sameDesign" type="radio" value="0" <?php if(!$orderDetail->IsRepeatOrder){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="changeDays('takeOrder');showHistoryOrderNumber();calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][42]);?>	
                       ...
                       <tr>
					  	 <td>13.<?php Lang::EchoString2($langdate['takeorder2'][15]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/prototype_comment.php');">?</span>] </td>
						 <td colspan="3">
							<input name="prototype" id="prototype" type="radio" value="1" <?php if($orderDetail->IsPrototype){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][43]);?>
							<input name="prototype" id="prototype" type="radio" value="0" <?php if(!$orderDetail->IsPrototype){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][42]);?>
						</td>
					   </tr>
                       <tr>
					  	 <td>14.<?php Lang::EchoString2($langdate['takeorder2'][16]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/stencil_comment.php');">?</span>] </td>
						 <td colspan="3">
							<input name="needStencil" id="needStencil" type="radio" value="1" <?php if($orderDetail->IsLaserStencil == 1){echo 'checked="checked"';} ?> onclick="changeStencil('takeOrder');calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][43]);?>
							<input name="needStencil" id="needStencil" type="radio" value="0" <?php if($orderDetail->IsLaserStencil == 0){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="changeStencil('takeOrder');calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][42]);?>
							<input name="needStencil" id="needStencil" type="radio" value="2" <?php if($orderDetail->IsLaserStencil == 2){echo 'checked="checked"';} ?> onclick="changeStencil('takeOrder');calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][46]);?><br/>
							<span id="spanStencilType" <?php if(!$orderDetail->IsLaserStencil){echo 'style="display:none"';} ?>>
								<input name="stencilType" type="radio" value="1" <?php if($orderDetail->Int1 == 1){echo 'checked="checked"';} if(!$orderDetail){echo 'checked="checked"';}?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][39]);?>
								<input name="stencilType" type="radio" value="2" <?php if($orderDetail->Int1 == 2){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][40]);?>
								<input name="stencilType" type="radio" value="3" <?php if($orderDetail->Int1 == 3){echo 'checked="checked"';} ?> onclick="calculate_totalB('takeOrder')"><?php Lang::EchoString2($langdate['takeorder2'][41]);?>
							</span>
						 </td>
					   </tr>
					    <tr  style="display:none">
					  	 <td>15.<?php Lang::EchoString2($langdate['takeorder2'][17]);?>: 
								[<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/tech_comment.php');">?</span>]</td>
						<td colspan="3">
							<input name="tech" id="tech" type="radio" value="1" onclick="calculate_totalB('takeOrder')">Yes
							<input name="tech" id="tech" type="radio" value="0" checked="checked" onclick="calculate_totalB('takeOrder')">No
						</td>
					   </tr>
                       <tr>
					  	 <td>15.<?php Lang::EchoString2($langdate['takeorder2'][19]);?>: [<span class="c_red helper dialogShow" onmouseover="ShowDialog(this,'/comment/voucher_comment.php');">?</span>] </td>
						<td colspan="3">
							<?php Lang::EchoString2($langdate['takeorder2'][20]);?>: <input name="voucherNumber" id="voucherNumber" type="text" onblur="calculate_totalB('takeOrder')" />
                       ...
                       <tr>
					  	 <td colspan="4" align="center">
					  		&nbsp;
					  		<!--<input name="Button1" onclick="calculate_totalB('takeOrder')" type="button" value="<?php Lang::EchoString2($langdate['takeorder2'][44]);?>" height="10" style="width:160px;height:40px;font-size:16px;color:red;" class="style18" >-->
					  	</td>
						 <td>
						 <span id="spanTotal" class="c_f30" style="line-height:15px;font-size:20px;display:none"></span><br/><br/>
						 <span id="spanPriceExcVAT"  class="c_f30" style="line-height:15px;font-size:20px;display:none"></span>
						...
						<input name="price19" id="price19" type="hidden">
						<input name="price20" id="price20" type="hidden">
						<input name="price21" id="price21" type="hidden">
						<input name="price22" id="price22" type="hidden">
						<input name="price23" id="price23" type="hidden">
						<input name="price24" id="price24" type="hidden">
						<input name="price25" id="price25" type="hidden">
						<input name="price26" id="price26" type="hidden">
						<input name="price27" id="price27" type="hidden">
						<input name="price28" id="price28" type="hidden">
						<input name="price29" id="price29" type="hidden">
						<input name="price30" id="price30" type="hidden">
				...
				<div id="calResult" style="display:none">
					<h3 class="title_main">Pricing And Build Time
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mt10 tab1">
					 <tr>
					  ...
					  <tr>
							...
							<td align="center" id="tdpcbNormalCost" style="background-color:#f60;cursor:pointer" onclick="choosePcbPrice('pcbNormalCost');calculate_totalB('takeOrder')">
					  ...
					  <tr>
							...
							<td align="center" id="tdpcbFastCost" style="cursor:pointer" onclick="choosePcbPrice('pcbFastCost');calculate_totalB('takeOrder')">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mt10 tab1"  >
					 <tr>
							<td align="center" colspan="2" style="font-weight:bold; font-size:14px">
								&nbsp;Carrier: DHL
							<!--<select name="selShip" id="selShip" style="width: 155px" onchange="">
					  ...
					  <tr>
							<td align="center" width="180">PCB Cost<span id="currencyType" name="currencyType"></span>:</td>
					...
					<div class="main_box clearbox mt10" style="display:none">
						<img src="/rescources/images/stencil.png" width="42" height="57" alt="" class="nr_m10 fl" />
						<div class="right_box1 fr lh2em">
							<span class="c_f30">*</span><?php Lang::EchoString2($langdate['takeOrder'][24]);?>.<br/>
							<span class="c_f30">*</span><?php Lang::EchoString2($langdate['takeOrder'][25]);?>.<br/>
							<span class="c_f30">*</span><?php Lang::EchoString2($langdate['takeOrder'][26]);?>.<br/>
							<span class="c_f30">*</span><?php Lang::EchoString2($langdate['takeOrder'][29]);?>.
						</div>
						<div class="clear"></div>
					</div>
					<div class="main_box clearbox mt10" style="display:none">
						...
						<div class="right_box1 fr lh2em">
							<p class="c_f30"><?php Lang::EchoString2($langdate['takeOrder'][27]);?></p>
							<p><?php Lang::EchoString2($langdate['takeOrder'][28]);?>. </p>
						</div>
						<div class="clear"></div>
					</div>
					<p class="mt10 tc"><input type="button" value="<?php Lang::EchoString2($langdate['takeorder2'][33]);?>" class="submit_bn" onclick="window.location='/sinoOrder/takeorder.php';"/>&nbsp;&nbsp;<input type="submit" value="<?php Lang::EchoString2($langdate['takeorder2'][34]);?>" class="submit_bn" onclick="getValues();"/>
					</p>
				</div><!--calResult-->
				</div>
			</form>
...
<?php
if(!empty($_SESSION[pcbOnlineBCuoteData])){
	echo "<script>changeLayer('');changeThickness('');changeDays('takeOrder');changeStencil('takeOrder');</script>";
	unset($_SESSION[pcbOnlineBCuoteData]);
}
?>