...
$langdate['selectTakeOrder'][2]['french']='Order PCB';
...
$langdate['selectTakeOrder'][9]['french']='Order Electronic components';
...
{
	echo "<script type='text/javascript'>location.href='../sinoOrder/takeorder.php?isLogin=yes';</script>";
	exit();
}
?>
