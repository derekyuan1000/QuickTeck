...
<a href="http://www.facebook.com/quickteck"  target="_blank"><img src="/rescources/images/img2.gif" width="30" height="30" alt="" /></a></p>
		...
		<div class="left_box_b"></div>
				...
				<input type="hidden" name="price19" value="<?php echo $_POST['price19']?>"/>
				<input type="hidden" name="price20" value="<?php echo $_POST['price20']?>"/>
				<input type="hidden" name="price21" value="<?php echo $_POST['price21']?>"/>
				<input type="hidden" name="price22" value="<?php echo $_POST['price22']?>"/>
				<input type="hidden" name="price23" value="<?php echo $_POST['price23']?>"/>
				<input type="hidden" name="price24" value="<?php echo $_POST['price24']?>"/>
				<input type="hidden" name="price25" value="<?php echo $_POST['price25']?>"/>
				<input type="hidden" name="price26" value="<?php echo $_POST['price26']?>"/>
				<input type="hidden" name="price27" value="<?php echo $_POST['price27']?>"/>
				<input type="hidden" name="price28" value="<?php echo $_POST['price28']?>"/>
				<input type="hidden" name="price29" value="<?php echo $_POST['price29']?>"/>
				<input type="hidden" name="price90" value="<?php echo $_POST['price30']?>"/>
				...
				<!--  end mian 2 -->
					...
					<p class="mt10 tc"><input type="button" value="<?php Lang::EchoString2($langdate['takeorder3'][5]);?>" class="submit_bn" onclick="window.location='/sinoOrder/takeorder2.php';"/>&nbsp;&nbsp;<input type="submit" value="<?php Lang::EchoString2($langdate['takeorder3'][6]);?>" class="submit_bn" />
					</p>
				</div>
			</form>
		</div>
