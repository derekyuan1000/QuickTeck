...
<div class="w980 auto clearbox mt5">
		...
		<div class="bnav ico_home mt10"><a href="/" title="">Home</a> - <a href="#" title="">Design quote</a> </div>
...
$to_ch = "1206200302@qq.com,1120275135@qq.com,info@quick-teck.co.uk";//Chinese Email To
$from_ch = "1206200302@qq.com";//Chinese Email From

$name = $_REQUEST['name'] ; 
//$headers = "From: $from"; 
$headers = "From:$from\r\nBCC:$bcc\r\nContent-type:text/html; charset=utf-8";
//$subject = "Web Contact Data(design_quote)"; 
$subject = "Electronic Design Service Quote Form";
...
/*$body = "We have received the following information:
		The uploade design file is:\" ". basename( $_FILES['uploaded']['name']). " \"
		<br>The order information is the following: <br>";*/
$body = "Electronic Design Service Quote Form<br><br>The uploade design file is:\" ". basename( $_FILES['uploaded']['name']). " \"<br>";
