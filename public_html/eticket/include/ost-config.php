...
define('SECRET_SALT','KF3b43R4NVlbvi5');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','gelukmobile@hotmail.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','quickte2_stc1');
define('DBUSER','quickte2_stc1');
define('DBPASS','vz9HJltU9N');
