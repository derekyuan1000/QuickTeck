            <div class="flow-ctn flowBG1">
        	<span class="flow" style="margin:48px 0 0 380px;">
        	...
        	<span class="flow" style="margin: 42px 0 0 380px;">
        	...
        	<span class="flow" style="margin:83px 0 0 88px;">
                <span class="f60" id="b1">
                    <span class="fl"></span><span class="fm" style="width:184px;"><div style="height:10px; overflow:hidden;"></div>Customer start sourcing<br/>the componens</span><span class="fr"></span>
                    <label><?php $p = $orderProcessingService->GetOrderProcessingByOrderIdAndStatusId($order->Id, 16); echo Common::ChangeDateFormat($p->ProcessTime,"dateTime"); ?></label>
                </span>
            </span>
        	<span class="flow" style="margin: 83px 0 0 15px;">
        	...
        	<span class="flow" style="margin: 45px 0 0 88px;">
                <span class="f81" id="b2">
                    <span class="fl"></span><span class="fm" style="width:184px;"><div style="height:10px; overflow:hidden;"></div>Customer arranges the<br/>components shipping to<br/>QT Hong Kong office.</span><span class="fr"></span>
                    <label><?php $p = $orderProcessingService->GetOrderProcessingByOrderIdAndStatusId($order->Id, 17); echo Common::ChangeDateFormat($p->ProcessTime,"dateTime"); ?></label>
                </span>
            </span>
        	<span class="flow" style="margin: 45px 0 0 15px;">
        	...
        	<span class="flow" style="margin: 45px 0 0 88px;">
                <span class="f60" id="b3">
                    <span class="fl"></span><span class="fm" style="width:184px;"><div style="height:10px; overflow:hidden;"></div>Components recevied,<br/>checking in progress</span><span class="fr"></span>
                    <label><?php $p = $orderProcessingService->GetOrderProcessingByOrderIdAndStatusId($order->Id, 18); echo Common::ChangeDateFormat($p->ProcessTime,"dateTime"); ?></label>
                </span>
            </span>
        	<span class="flow" style="margin: 45px 0 0 15px;">
        	...
        	<span class="flow" style="margin: 45px 0 0 315px;">
        	...
        	<span class="flow" style="margin: 45px 0 0 88px;">
                <span class="f60" id="b4">
                    ...
                    <label><?php $p = $orderProcessingService->GetOrderProcessingByOrderIdAndStatusId($order->Id, 19); echo Common::ChangeDateFormat($p->ProcessTime,"dateTime"); ?></label>
                </span>
            </span>
        	<span class="flow" style="margin: 45px 0 0 15px;">
                <span class="f60" id="c5">
                    <span class="fl"></span><span class="fm" style="width:161px;"><div style="height:10px; overflow:hidden;"></div>Components ready for<br/>assembly</span><span class="fr"></span>
        	...
        	<span class="flow" style="margin: 70px 0 0 380px;">
        	...
        	<span class="flow" style="margin: 43px 0 0 380px;">
